  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-full bg-green-900/30 border border-green-800 flex items-center justify-center shrink-0">
          <svg className="size-6 text-green-400 fill-green-400" viewBox="0 0 24 24">
